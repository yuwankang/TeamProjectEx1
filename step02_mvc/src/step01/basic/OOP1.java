 ...
 * 	상속받는 주체: 자식 클래스(하위 클래스)
 * 3.클래스 구성
 * 		1.기본요소: 변수 / 생성자 / 메소드
 * 		2.상속 관계에선 자식이 상속 받는 요소: 변수와 메소드
 * 			-자식 클래스 관점에서 데이터 수정, 메소드 기능 편집(재정의, overloading, override)
 * 
 * 4.원리
...
public class OOP1 extends java.lang.Object {
	public OOP1() {
	...
	public static void main(String[] args) {
		...
		c.printAll(); //상속받은 메소드로 id/pw값만 출력
		
		//다형성 - 상속 관계가 전제조건
		Parent p = new Child();
		p.id = "master";
//		p.grade = "vvip"; // error
		Child c2 = (Child)p; //객체 타입 간의 명시적인 형변환 문법
		c2.grade = "vvip";
